...
<h4>
	Calibration - Step {step} of 3 {#if selectedScale > 0} of scale {selectedScale}{/if}
</h4>
{#if step == 1 || step == undefined}
	<p>
		We have to calibrate the weight in order to use it propperly. This usually only needs to be done once, insofar as you are using identical bottles. However,
		small deviations in the 1% range may occur due to slight differences in the bottle weights.
	</p>
	<p>
	...
	{#if selectedScale > 0}
		<p>
			If the weight of the gas bottle has changed, you can enter it here. The value printed on the bottle serves as a reference value, but we recommend using
			your own scale for this.
		</p>
		<div class="row">
			<div class="col-sm-4">
...
{:else if step == 2}
	...
	<p>In this step, the sensor is calibrated to 0 and then a known weight is measured in the next step.</p>
	<div class="row">
		<div class="col-sm-6">
...
{:else}
	<p>
		You should now place a relatively heavy object, whose exact weight you know, on the scale. If necessary, you can measure something in advance with another
		scale.
	</p>
	<p>
